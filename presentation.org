...
#+begin_notes
Monoids embody a fundamental shape of computation. It's a tool for talking about
code.
...
double-dispatch." It means "I think we could benefit from the ability to
easily add behaviours over types."
#+end_notes
...
The ability to have a recursive-lambda overload set (see e.g. P0784) helps.
